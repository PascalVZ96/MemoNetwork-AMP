...
echo "Status detection now uses one lightweight 2.5-second check."
echo "The heavy MutationObserver status loop has been removed."
echo "Control Center interface is English."
